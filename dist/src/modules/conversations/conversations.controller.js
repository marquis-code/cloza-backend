...
let ConversationsController = class ConversationsController {
    ...
    async startConversation(dto) {
        return this.conversationsService.startConversation(dto.workspaceId, dto.customerId, dto.platform);
    }
    async sendMessage(req, dto) {
        return this.conversationsService.sendMessage(req.user.id, client_1.SenderType.USER, dto);
    }
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Start or get a conversation' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [conversation_dto_1.StartConversationDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, conversation_dto_1.CreateMessageDto]),
    __metadata("design:returntype", Promise)
], ConversationsController.prototype, "sendMessage", null);
__decorate([
    (0, common_1.Get)('workspace/:workspaceId'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all conversations for a workspace' }),
